...
//add on 2012-11-05
var JsMotto=function(){};   
JsMotto.prototype.motto = function(success, error){
    return PhoneGap.exec( success, error,
                'JMotto', //java类名，plugins.xml中注册的名字
                'actiona',    //action，Java方法中用来匹配的字段
                ["",""]    //params 传递的参数，Array形式
    );
};

PhoneGap.addConstructor(function() {
PhoneGap.addPlugin('JsMotto', new JsMotto());
});

//add on 2012-11-05
var JTester=function(){};   
JTester.prototype.tester = function(success, error, testData1, testData2){
    return PhoneGap.exec( success, error,
                'JTest', //java����plugins.xml��ע�������
                'actiona',    //action��Java����������ƥ����ֶ�
                [testData1, testData2]    //params ���ݵĲ���Array��ʽ
    );
};
PhoneGap.addConstructor(function() {
PhoneGap.addPlugin('JTester', new JTester());
});
